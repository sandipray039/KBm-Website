            ...
            <div className="col-sm-6 col-md-3">
             ...
             <p  style={{fontSize:'1.5vw'}}>खतियानी बुद्धिजीवी मंच</p>
                    ...
                    <ul className="list-inline mt-5">
                        <li className="m-0 pl-10 pr-10"> <i className="fa fa-phone mr-5"></i> <a className="text-white" href="#">6207723381</a> </li>  <br>
                        </br>
                        <li className="m-0 pl-10 pr-10"> <i className="fa fa-envelope-o mr-5"></i> <a className="text-white" href=""><span className="__cf_email__" data-cfemail="63000c0d17020017231a0c1611070c0e020a0d4d000c0e">kbmofficial2024@gmail.com</span></a> </li>
                        <li className="m-0 pl-10 pr-10"> <i className="fa fa-globe mr-5"></i> <Link
  ...
  www.kbm.org.in
            ...
            <div className="col-sm-6 col-md-3 ml-200">
                <div className="widget dark" style={{color:'white'}}>
                    <h5 className="widget-title border-bottommm border-white ">Useful Links</h5>
                    <ul className="list angle-double-right  border-bottomm border-white" style={{color:'black'}}>
                        <li><Link className='text-white  border-bottomm border-white' to="/about">About Us</Link></li>
                        <li><Link className='text-white  border-bottomm border-white' to="/team">Volunteer</Link></li>
                        <li><Link className='text-white  border-bottomm border-white' to="/gallery">Gallery</Link></li>
                        <li><Link className='text-white  border-bottomm border-white' to="/donationpage">Donate Us</Link></li>
                        <li><Link className='text-white  border-bottomm border-white' to="/memberjoin">Join Us</Link></li>
                    </ul>
                </div>
            </div>
            <div className="col-sm-6 col-md-3">
                <div className="widget dark">
                    <h5 className="widget-title  border-bottommm border-white">Details</h5>
  ...
  >
    Join Us
                            ...
                            <li className="clearfix">
                                <span  className=' border-bottomm border-white' > Call Us Now : 6207723381  </span>
                    ...
                    <ul className="styled-icons icon-dark icon-theme-colored icon-circled icon-sm">
                        <li><a href="https://www.facebook.com/people/"><i className="fa fa-facebook"></i></a></li>
                        {/* <li><a href="#"><i className="fa fa-twitter"></i></a></li>
                        <li><a href="#"><i className="fa fa-skype"></i></a></li> */}
                        <li><a href="https://www.youtube.com/@KBMcharity"><i className="fa fa-youtube"></i></a></li>
