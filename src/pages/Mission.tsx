                             ...
                             <div className="col-xs-9 pr-10 pl-10">
                                 <div className="event-content mt-10 p-5 pb-0 pt-0">
                                     ...
                                     <ul className="list-inline font-weight-600 text-gray-dimgray">
                                         <li><i className="fa fa-clock-o text-theme-colored"></i> 5.00 pm - 7.30 pm</li>
                                         <li> <i className="fa fa-map-marker text-theme-colored"></i> 25 Newyork City.</li>
                                     </ul>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div className="row">
                             ...
                             <div className="col-xs-9 pr-10 pl-10">
                                 <div className="event-content mt-10 p-5 pb-0 pt-0">
                                     ...
                                     <ul className="list-inline font-weight-600 text-gray-dimgray">
                                         <li><i className="fa fa-clock-o text-theme-colored"></i> 6.00 pm - 8.30 pm</li>
                                         <li> <i className="fa fa-map-marker text-theme-colored"></i> 25 Newyork City.</li>
                                     </ul>
                                 </div>
                             </div>
                         ...
                         <div className="row">
                             ...
                             <div className="col-xs-9 pr-10 pl-10">
                                 <div className="event-content mt-10 p-5 pb-0 pt-0">
                                     ...
                                     <ul className="list-inline font-weight-600 text-gray-dimgray">
                                         <li><i className="fa fa-clock-o text-theme-colored"></i> 4.00 pm - 6.00 pm</li>
                                         <li> <i className="fa fa-map-marker text-theme-colored"></i> 25 Newyork City.</li>
                                     </ul>
                                 </div>
                             </div>
